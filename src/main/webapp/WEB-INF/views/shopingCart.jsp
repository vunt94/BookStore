...
<form class="bg0 p-t-75 p-b-85">
    <div class="container">
        <div class="row">
                ...
                <div class="m-l-25 m-r--38 m-lr-0-xl">
                    ...
                    <div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
                        <div class="flex-w flex-m m-r-20 m-tb-5">
                            <div onclick="updateCart(event)" class="flex-c-m stext-101 cl2 size-118 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-5">
                                UPDATE CART
                            </div>
                        </div>
                    </div>
            ...
            <div id="clickToCheckout" class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50 hid">
                <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
                    ...
                    <div class="flex-w flex-t p-t-27 p-b-33">
                        ...
                        <a href="/payment" class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">
                            Proceed to Checkout
                        </a>
                </div>
            </div>
