...
<section class="section-slide">
    <div class="wrap-slick1">
        <div class="slick1">
            <div class="item-slick1" style="background-image: url('images/2.jpg');">
            ...
            <div class="item-slick1" style="background-image: url(images/1.jpg);">
                <div class="container h-full">
                    <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                ...
                <div class="block1 wrap-pic-w">
                    <img src="images/4.jpg" alt="IMG-BANNER">
    ...
    <div class="container">
        ...
        <div class="flex-w flex-sb-m p-b-52">
            <div class="flex-w flex-l-m filter-tope-group m-tb-10">
                ...
                <c:forEach items="${lstCategory}" var="item">
                <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 ${categoryID == item.ID ? "how-active1":""}" data-filter=".women">
                    <a href="/?cateId=${item.ID}" style="color: black">${item.cateName}</a>
                </button>
                </c:forEach>
        ...
        <div class="row isotope-grid">
            <c:forEach var="item" items="${lstProduct.content}">
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                ...
                <div class="block2">
                    <div class="block2-pic hov-img0">
                        ...
                        <a href="/quickView/${item.ID}" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
                            Quick View
                        </a>
                    </div>
